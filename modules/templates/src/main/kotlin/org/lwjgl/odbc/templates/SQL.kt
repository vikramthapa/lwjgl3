...
val sql = "SQL".nativeClass(ODBC_PACKAGE, prefix = "SQL", prefixMethod = "SQL", binding = ODBC_BINDING) {
	...
	ShortConstant(
		...
		"ERROR".."-1",
		"SUCCESS"..0.s,
		"SUCCESS_WITH_INFO"..1.s,
		"STILL_EXECUTING"..2.s,
		"NEED_DATA"..99.s,
		"NO_DATA"..100.s,
		"NO_DATA_FOUND".."SQL_NO_DATA",
		"PARAM_DATA_AVAILABLE"..101.s
	)
	...
	val DiagnosticsFields = ShortConstant(
		...
		"DIAG_SQLSTATE"..4.s,
		"DIAG_NATIVE"..5.s,
		"DIAG_MESSAGE_TEXT"..6.s,
		"DIAG_DYNAMIC_FUNCTION"..7.s,
		"DIAG_CLASS_ORIGIN"..8.s,
		"DIAG_SUBCLASS_ORIGIN"..9.s,
		"DIAG_CONNECTION_NAME"..10.s,
		"DIAG_SERVER_NAME"..11.s,
		"DIAG_DYNAMIC_FUNCTION_CODE"..12.s
	).javaDocLinks
	...
	IntConstant(
		"Defines used by Driver Manager when mapping #SetParam() to #BindParameter().",
	...
	IntConstant(
		"#ColAttributes() subdefines for #COLUMN_UPDATABLE.",
	...
	IntConstant(
		"#ColAttributes() subdefines for #COLUMN_SEARCHABLE. These are also used by #GetInfo().",
	...
	val InfoTypesExtended = ShortConstant(
		...
		"ACTIVE_STATEMENTS"..1.s,
		"DRIVER_HDBC"..3.s,
		"DRIVER_HENV"..4.s,
		"DRIVER_HSTMT"..5.s,
		"DRIVER_NAME"..6.s,
		"DRIVER_VER"..7.s,
		"ODBC_API_CONFORMANCE"..9.s,
		"ODBC_VER"..10.s,
		"ROW_UPDATES"..11.s,
		"ODBC_SAG_CLI_CONFORMANCE"..12.s,
		"ODBC_SQL_CONFORMANCE"..15.s,
		"PROCEDURES"..21.s,
		"CONCAT_NULL_BEHAVIOR"..22.s,
		"CURSOR_ROLLBACK_BEHAVIOR"..24.s,
		"EXPRESSIONS_IN_ORDERBY"..27.s,
		"MAX_OWNER_NAME_LEN"..32.s,
		"MAX_PROCEDURE_NAME_LEN"..33.s,
		"MAX_QUALIFIER_NAME_LEN"..34.s,
		"MULT_RESULT_SETS"..36.s,
		"MULTIPLE_ACTIVE_TXN"..37.s,
		"OUTER_JOINS"..38.s,
		"OWNER_TERM"..39.s,
		"PROCEDURE_TERM"..40.s,
		"QUALIFIER_NAME_SEPARATOR"..41.s,
		"QUALIFIER_TERM"..42.s,
		"SCROLL_OPTIONS"..44.s,
		"TABLE_TERM"..45.s,
		"CONVERT_FUNCTIONS"..48.s,
		"NUMERIC_FUNCTIONS"..49.s,
		"STRING_FUNCTIONS"..50.s,
		"SYSTEM_FUNCTIONS"..51.s,
		"TIMEDATE_FUNCTIONS"..52.s,
		"CONVERT_BIGINT"..53.s,
		"CONVERT_BINARY"..54.s,
		"CONVERT_BIT"..55.s,
		"CONVERT_CHAR"..56.s,
		"CONVERT_DATE"..57.s,
		"CONVERT_DECIMAL"..58.s,
		"CONVERT_DOUBLE"..59.s,
		"CONVERT_FLOAT"..60.s,
		"CONVERT_INTEGER"..61.s,
		"CONVERT_LONGVARCHAR"..62.s,
		"CONVERT_NUMERIC"..63.s,
		"CONVERT_REAL"..64.s,
		"CONVERT_SMALLINT"..65.s,
		"CONVERT_TIME"..66.s,
		"CONVERT_TIMESTAMP"..67.s,
		"CONVERT_TINYINT"..68.s,
		"CONVERT_VARBINARY"..69.s,
		"CONVERT_VARCHAR"..70.s,
		"CONVERT_LONGVARBINARY"..71.s,
		"ODBC_SQL_OPT_IEF"..73.s,
		"CORRELATION_NAME"..74.s,
		"NON_NULLABLE_COLUMNS"..75.s,
		"DRIVER_HLIB"..76.s,
		"DRIVER_ODBC_VER"..77.s,
		"LOCK_TYPES"..78.s,
		"POS_OPERATIONS"..79.s,
		"POSITIONED_STATEMENTS"..80.s,
		"BOOKMARK_PERSISTENCE"..82.s,
		"STATIC_SENSITIVITY"..83.s,
		"FILE_USAGE"..84.s,
		"COLUMN_ALIAS"..87.s,
		"GROUP_BY"..88.s,
		"KEYWORDS"..89.s,
		"OWNER_USAGE"..91.s,
		"QUALIFIER_USAGE"..92.s,
		"QUOTED_IDENTIFIER_CASE"..93.s,
		"SUBQUERIES"..95.s,
		"UNION"..96.s,
		"MAX_ROW_SIZE_INCLUDES_LONG"..103.s,
		"MAX_CHAR_LITERAL_LEN"..108.s,
		"TIMEDATE_ADD_INTERVALS"..109.s,
		"TIMEDATE_DIFF_INTERVALS"..110.s,
		"NEED_LONG_DATA_LEN"..111.s,
		"MAX_BINARY_LITERAL_LEN"..112.s,
		"LIKE_ESCAPE_CLAUSE"..113.s,
		"QUALIFIER_LOCATION"..114.s,
		"ACTIVE_ENVIRONMENTS"..116.s,
		"ALTER_DOMAIN"..117.s,
		"SQL_CONFORMANCE"..118.s,
		"DATETIME_LITERALS"..119.s,
		"ASYNC_MODE"..10021.s,
		"BATCH_ROW_COUNT"..120.s,
		"BATCH_SUPPORT"..121.s,
		...
		"CONVERT_WCHAR"..122.s,
		"CONVERT_INTERVAL_DAY_TIME"..123.s,
		"CONVERT_INTERVAL_YEAR_MONTH"..124.s,
		"CONVERT_WLONGVARCHAR"..125.s,
		"CONVERT_WVARCHAR"..126.s,
		"CREATE_ASSERTION"..127.s,
		"CREATE_CHARACTER_SET"..128.s,
		"CREATE_COLLATION"..129.s,
		"CREATE_DOMAIN"..130.s,
		"CREATE_SCHEMA"..131.s,
		"CREATE_TABLE"..132.s,
		"CREATE_TRANSLATION"..133.s,
		"CREATE_VIEW"..134.s,
		"DRIVER_HDESC"..135.s,
		"DROP_ASSERTION"..136.s,
		"DROP_CHARACTER_SET"..137.s,
		"DROP_COLLATION"..138.s,
		"DROP_DOMAIN"..139.s,
		"DROP_SCHEMA"..140.s,
		"DROP_TABLE"..141.s,
		"DROP_TRANSLATION"..142.s,
		"DROP_VIEW"..143.s,
		"DYNAMIC_CURSOR_ATTRIBUTES1"..144.s,
		"DYNAMIC_CURSOR_ATTRIBUTES2"..145.s,
		"FORWARD_ONLY_CURSOR_ATTRIBUTES1"..146.s,
		"FORWARD_ONLY_CURSOR_ATTRIBUTES2"..147.s,
		"INDEX_KEYWORDS"..148.s,
		"INFO_SCHEMA_VIEWS"..149.s,
		"KEYSET_CURSOR_ATTRIBUTES1"..150.s,
		"KEYSET_CURSOR_ATTRIBUTES2"..151.s,
		"MAX_ASYNC_CONCURRENT_STATEMENTS"..10022.s,
		"ODBC_INTERFACE_CONFORMANCE"..152.s,
		"PARAM_ARRAY_ROW_COUNTS"..153.s,
		"PARAM_ARRAY_SELECTS"..154.s,
		"SCHEMA_TERM".."SQL_OWNER_TERM",
		"SCHEMA_USAGE".."SQL_OWNER_USAGE",
		"SQL92_DATETIME_FUNCTIONS"..155.s,
		"SQL92_FOREIGN_KEY_DELETE_RULE"..156.s,
		"SQL92_FOREIGN_KEY_UPDATE_RULE"..157.s,
		"SQL92_GRANT"..158.s,
		"SQL92_NUMERIC_VALUE_FUNCTIONS"..159.s,
		"SQL92_PREDICATES"..160.s,
		"SQL92_RELATIONAL_JOIN_OPERATORS"..161.s,
		"SQL92_REVOKE"..162.s,
		"SQL92_ROW_VALUE_CONSTRUCTOR"..163.s,
		"SQL92_STRING_FUNCTIONS"..164.s,
		"SQL92_VALUE_EXPRESSIONS"..165.s,
		"STANDARD_CLI_CONFORMANCE"..166.s,
		"STATIC_CURSOR_ATTRIBUTES1"..167.s,
		"STATIC_CURSOR_ATTRIBUTES2"..168.s,
		"AGGREGATE_FUNCTIONS"..169.s,
		"DDL_INDEX"..170.s,
		"DM_VER"..171.s,
		"INSERT_STATEMENT"..172.s,
		"CONVERT_GUID"..173.s,
		"UNION_STATEMENT".."SQL_UNION",

		"ASYNC_DBC_FUNCTIONS"..10023.s,
		"DRIVER_AWARE_POOLING_SUPPORTED"..10024.s,
		"ASYNC_NOTIFICATION"..10025.s
	).javaDocLinks
	...
	IntConstant(
		"Supported values for #ATTR_SCROLL_CONCURRENCY.",
	...
	val BulkOperations = ShortConstant(
		...
		"UPDATE_BY_BOOKMARK"..5.s,
		"DELETE_BY_BOOKMARK"..6.s,
		"FETCH_BY_BOOKMARK"..7.s
	).javaDocLinks
	...
	NativeName("SQLNativeSqlW")..SQLRETURN(
		...
		SQLCHARUTF16_p.OUT("OutStatementText", ""),
	...
	SQLRETURN(
		...
		Check(1)..SQLULEN_p.OUT("ParameterSizePtr", ""),
	...
	SQLRETURN(
		...
		SQLHSTMT.IN("StatementHandle", ""),
		Check(1)..SQLSMALLINT_p.OUT("ParameterCountPtr", "")
	)
